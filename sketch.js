var child, gameState, graphics, img, density,canvas, ammo, ammoCount, shop1, top1, bottom1, left1, right1, child_img, enter_img, startBut_img, missionText_img, shopbut_img, ped1_img, shopText_img,enemyGroup, bulletGroup, mission1, mission2, mission3, mission4, mission5, destinationMarker, van_img, van, minMap;
...
function renderMap() {
    ...
    image(img, child.x + windowWidth/2-1000,child.y+windowHeight/2-550, 1000, 1000 / aspect, 10, 10, img.width * 10, img.height * 10);
    push();
    noFill();
    strokeWeight(3);
    rect(child.x + windowWidth/2-1000,child.y+windowHeight/2-550, 1000, 1000 / aspect);
    pop();
}
